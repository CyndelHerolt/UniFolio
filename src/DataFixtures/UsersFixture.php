...
class UsersFixture extends Fixture implements OrderedFixtureInterface
{
    ...
    ): void
    {
        ...
        $user3->setUsername('etudiant1')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant1@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        ...
        $etudiant->setMailUniv('etudiant1@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0103456789');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant1');
        ...
        $user4->setUsername('etudiant2')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant2@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();

        $etudiant->setUsers($user4);

        $etudiant->setNom('etudiant2');
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant2@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0163456781');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant2');
        ...
        $user5->setUsername('etudiant3')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant3@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();

        $etudiant->setUsers($user5);

        $etudiant->setNom('etudiant3');
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant3@etudiant.univ-reims.fr');
        $etudiant->setTelephone('015345581');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant3');
        ...
        $user6->setUsername('etudiant4')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant4@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();
        ...
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant4@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0163458881');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant4');
        ...
        $user7->setUsername('etudiant5')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant5@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();
        ...
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant5@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0193459991');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant5');
        ...
        $user8->setUsername('etudiant6')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant6@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();
        ...
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant6@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0193454539');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant6');
        ...
        $user9->setUsername('etudiant7')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant7@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();
        ...
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant7@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0193454539');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant7');
        ...
        $user10->setUsername('etudiant8')
            ->setPassword($password)
            ->setRoles(['ROLE_ETUDIANT'])
            ->setEmail('etudiant10@etudiant.univ-reims.fr')
            ->setIsVerified(true);
        $etudiant = new Etudiant();
        $biblio = new Bibliotheque();
        ...
        $etudiant->setPrenom('Jean');
        $etudiant->setMailPerso('persoTest@mail.com');
        $etudiant->setMailUniv('etudiant10@etudiant.univ-reims.fr');
        $etudiant->setTelephone('0193454539');
        $etudiant->setBio('Vestibulum elementum odio lectus, vitae tempor ante viverra non. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Ut scelerisque bibendum ipsum, non tincidunt risus ultrices vel.');
        $etudiant->setUsername('etudiant8');
        ...
        $user12->setUsername('enseignant1')
            ->setPassword($password)
            ->setRoles(['ROLE_ENSEIGNANT'])
            ->setEmail('prof1@univ-reims.fr')
            ->setIsVerified(true);
        $enseignant = new Enseignant();

        $enseignant->setUsers($user12);

        $enseignant->setNom('enseignant1');
        $enseignant->setPrenom('Jane');
        $enseignant->setMailPerso('persoTest@mail.com');
        $enseignant->setMailUniv('prof1@univ-reims.fr');
        $enseignant->setTelephone('0123456782');
        ...
        $enseignant->setPrenom('Jane');
        $enseignant->setMailPerso('persoTest@mail.com');
        $enseignant->setMailUniv('prof2@univ-reims.fr');
        $enseignant->setTelephone('0123456782');
        $enseignant->setUsername('enseignant2');
        ...
        $enseignant->setPrenom('Jane');
        $enseignant->setMailPerso('persoTest@mail.com');
        $enseignant->setMailUniv('prof4@univ-reims.fr');
        $enseignant->setTelephone('0123456782');
        $enseignant->setUsername('enseignant3');
        ...
        $enseignant->setUsername('enseignant4');
