...
class EnseignantDepartement extends BaseEntity
{
    ...
    public function __construct(#[ORM\ManyToOne(targetEntity: Enseignant::class, inversedBy: 'enseignantDepartements', cascade: ['persist', 'remove'])] private Enseignant $enseignant, #[ORM\ManyToOne(targetEntity: Departement::class, inversedBy: 'enseignantDepartements', cascade: ['persist', 'remove'])] private Departement $departement)
    {
