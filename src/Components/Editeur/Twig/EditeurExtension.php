...
use App\Components\Editeur\TypeElementParamsRenderer;
...
class EditeurExtension extends AbstractExtension
{
    public function __construct(
        ...
        private readonly TypeElementParamsRenderer $typeElementParamsRenderer,
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('element_params_render', $this->typeElementParamsRenderer->render(...), [
                'is_safe' => ['html'],
            ]),
